...
import com.eugene.aichat.core.network.dto.ChatMessageDto
...
class AgentRuntime @Inject constructor(
     ...
     * concrete [com.eugene.aichat.core.ai.client.AiClient] (so the
                    ...
                    is StreamEvent.ToolCallDelta -> {
                        ...
                        if (builder == null) {
                            collectedToolCalls += ToolCallDto(
                                id = ev.call.id ?: "",
                                function = com.eugene.aichat.core.network.dto.ToolCallFunctionDto(
