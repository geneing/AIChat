...
import com.github.geneing.aichat.core.ui.components.MarkdownText
...
@Composable
private fun SourceList(sources: List<com.github.geneing.aichat.core.domain.model.SourceRef>) {
    Row(
        modifier = Modifier
